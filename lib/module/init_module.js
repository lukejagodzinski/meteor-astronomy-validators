...
var validateAll = function() {
  ...
  _.each(validationOrder, function(patternOrFieldName) {
    var validatorsList = validatorsLists[patternOrFieldName];

    if (validatorsList) {
      validateList.call(
        doc,
        validatorsLists[patternOrFieldName],
        patternOrFieldName
      );
    }
  });
  ...
  validate: function() {
    ...
    try {
      if (arguments.length === 1) {
        validateOne.call(doc, arguments[0]);
      } else if (arguments.length === 0) {
        validateAll.call(doc);
      }
    } catch (e) {
      if (e instanceof ValidationError) {
        _.each(e.errors, function(error, i) {

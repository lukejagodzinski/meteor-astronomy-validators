UI.registerHelper('getValidationError', function(options) {
  var fieldName;
  ...
  if (!fieldName) {
    throw new Error(
      'The "field" argument in the "getValidationError" helper has to be ' +
      'provided'
    );
  }
  ...
  return object.getValidationError(fieldName);
});

UI.registerHelper('hasValidationError', function(options) {
  var fieldName;
  ...
  if (!fieldName) {
    throw new Error(
      'The "field" argument in the "hasValidationError" helper has to be ' +
      'provided'
    );
  }
  ...
  return object.hasValidationError(fieldName);
});

...
events.afterset = function(e) {
  ...
  // Unset the "hasError" reactive variable so that no errors will be displayed
  // until the next validation process. It doesn't matter what field we have
  // set. We alway need to set this field.

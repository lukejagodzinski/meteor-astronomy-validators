...
checks.validatorDefinition = function(validatorDefinition) {
...
ValidatorDefinition = function(validatorDefinition) {
  ...
  this.name = validatorDefinition.name;
  this.validate = validatorDefinition.validate;
  this.aliases = validatorDefinition.aliases;
